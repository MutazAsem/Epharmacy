                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td class="cart-product-image">
                                            <a href="product-details.html"><img src="{{ asset('client/img/product/1.png')}}" alt="#"></a>
                                        </td>
                                    ...
                                    <tr>
                                        <td class="cart-product-remove">x</td>
                                        <td class="cart-product-image">
                                            <a href="product-details.html"><img src="{{ asset('client/img/product/2.png')}}" alt="#"></a>
                                        </td>
                                        <td class="cart-product-info">
                                    ...
                                    <tr>
                                        <td class="cart-product-remove">x</td>
                                        <td class="cart-product-image">
                                            <a href="product-details.html"><img src="{{ asset('client/img/product/3.png')}}" alt="#"></a>
                                        </td>
                                        <td class="cart-product-info">
