                    ...
                    <div class="ltn__checkout-inner">
                        ...
                        <div class="ltn__checkout-single-content mt-50">
                            ...
                            <div class="ltn__checkout-single-content-info">
                                <form wire:submit.prevent='updateAddress' action="#">
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="input-item input-item-name ">
                                                <input type="text" name="ltn__name" placeholder="Address Name"
                                                    wire:model='name' value="{{$address->name}}">
                                            </div>
                                            @error('name')
                                        ...
                                        <div class="input-item input-item-textarea ltn__custom-icon">
                                            <input type="text" name="ltn__message" placeholder="Write Address Description here." wire:model='description' value="{{$address->description}}"></input>
                                        </div>
                                        @error('description')
                                            <div style="color: red">{{ $message }} <br><br></div>
                                        @enderror
                                        <div class="input-item input-item-name ">
                                            <input type="text" name="ltn__name" placeholder="Address Link"
                                                wire:model='addressLink' value="{{$address->address_link}}">
                                        </div>
                                        @error('addressLink')
                                            <div style="color: red">{{ $message }} <br><br></div>
                                        @enderror
